...
class DemoCatalogV2
{
    ...
    public function seed(): array
    {
        return DB::transaction(function (): array {
            ...
            foreach ($this->sessions() as $data) {
                ...
                unset($data['experience_slug'], $data['location_slug']);
                ExperienceSession::updateOrCreate(['experience_id' => $experience->id, 'reference_key' => $data['reference_key']], $data + ['location_id' => $location?->id, 'status' => 'scheduled']);
            }
    ...
    private function experiences(): array
    {
        return [
            ...
            ['slug' => 'demo-cata-cafe-boliviano', 'title' => 'Cata de café boliviano', 'short_description' => 'Origen, aroma y conversación en una mesa.', 'description' => 'Recorre perfiles de café boliviano junto a personas que lo preparan cada día.', 'terms' => 'Incluye degustación guiada.', 'category' => 'cafe', 'experience_type' => 'tasting', 'duration_minutes' => 120, 'regular_price' => 65, 'member_price' => 50, 'currency' => 'BOB', 'reservation_method' => 'url', 'reservation_url' => 'https://demo.invalid/reservas/cata', 'featured' => true, 'partners' => [['demo-altura-nube', 'host', 1], ['demo-miga-cometa', 'participant', 2]]],
    ...
    private function sessions(): array
    {
        ...
        return [
            ...
            ['experience_slug' => 'demo-cata-cafe-boliviano', 'reference_key' => 'demo-cata-01', 'location_slug' => 'demo-altura-nube-cala-cala', 'starts_at' => $at(5, 18), 'ends_at' => $at(5, 20), 'capacity' => 18, 'venue_label' => 'Altura Nube · Cala Cala'], ['experience_slug' => 'demo-cata-cafe-boliviano', 'reference_key' => 'demo-cata-02', 'location_slug' => 'demo-miga-cometa', 'starts_at' => $at(19, 10), 'ends_at' => $at(19, 12), 'capacity' => null, 'venue_label' => 'Miga Cometa'],
            ...
            ['experience_slug' => 'demo-pausa-en-movimiento', 'reference_key' => 'demo-pausa-01', 'location_slug' => 'demo-distrito-pulso', 'starts_at' => $at(3, 19), 'ends_at' => $at(3, 20), 'capacity' => 20, 'venue_label' => 'Distrito Pulso'], ['experience_slug' => 'demo-pausa-en-movimiento', 'reference_key' => 'demo-pausa-02', 'location_slug' => 'demo-kintu-calma', 'starts_at' => $at(14, 9), 'ends_at' => $at(14, 10), 'capacity' => 16, 'venue_label' => 'Kintu Calma Spa'],
