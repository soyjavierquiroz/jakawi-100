...
{
    public function record(User $user, array $data): Conversion
    {
        ...
        $snapshot = ['referrer_user_id' => $relationship?->referrer_user_id, 'referral_code' => $relationship?->referral_code, 'utm_source' => $touch?->utm_source, 'utm_medium' => $touch?->utm_medium, 'utm_campaign' => $touch?->utm_campaign, 'utm_content' => $touch?->utm_content];
