...
class AdminSalesController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        if ($request->filled('promoter')) $query->where('collected_by_user_id', $request->integer('promoter'));
        if ($request->filled('date')) $query->whereDate('created_at', $request->string('date'));
